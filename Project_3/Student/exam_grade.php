...
$query = 'SELECT c.courseName, a.courseCode, a.sectionId, a.semester, a.yearr, a.eName, a.score
          FROM attends a, Course c
          WHERE a.sssn = "' . $ssn . '" AND c.courseCode = a.courseCode ';
...
if (mysqli_num_rows($result) > 0) {
    ...
    echo 'thre is no Exam to for you!';
}
?>
